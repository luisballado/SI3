...
\begin{frame}
  ...
  \item \textbf{3.- Propulsión -} Motores y hélices que proporcionan la fuerza necesaria para el vuelo.
  \end{itemize}
\end{frame}
...
\begin{frame}  
  ...
  \bigskip % Vertical whitespace
  \begin{itemize}
  \item ¿Dónde estoy? $\implies$ Localización y representación del medio ambiente \pause 
  \item ¿A dónde voy? $\implies$ Control \pause  %Cognición
  \item ¿Cómo llego hasta ahí? $\implies$ Planificación de trayectoria 
  \end{itemize}
  \pause
  \bigskip % Vertical whitespace
  Para resolver estas preguntas, el robot debe: \pause 
  \bigskip % Vertical whitespace
  \begin{itemize}
  \item Tener un modelo del ambiente (dado, o autónomamente construido) \pause 
  \item Localizarse dentro del ambiente \pause 
...
\begin{frame}{Control - ¿A dónde voy?}
