...
\begin{frame}{Control de un VANT}
  ...
  \begin{minipage}{0.47\textwidth}
    ...
    \small Un VANT de cuatro rotores cuenta con seis grados de libertar (DoF), tres coordenadas lineales x,y,z y tres coordenadas angulares y cuatro entradas $(u_1,u_2,u_3,u_4)$ o variables de control.\\
